...
describe('Stripe Utilities', () => {
        ...
        it('should throw error when required environment variables are missing', () => {
            ...
            requiredVars.forEach((envVar) => {
                ...
                expect(() => {
                    ...
                    `Missing required Stripe environment variables: ${envVar}`
                )
    ...
    describe('Configuration Object Structure', () => {
        it('should create proper stripe config object', () => {
            const stripeConfig = {
                isTestMode:
                    process.env.STRIPE_SECRET_KEY?.includes('test') || false,
    ...
    describe('Edge Cases', () => {
        ...
        it('should handle case sensitivity in environment variables', () => {
            ...
            expect(process.env.STRIPE_SECRET_KEY.startsWith('sk_')).toBe(false)
            expect(
                process.env.STRIPE_SECRET_KEY.toLowerCase().startsWith('sk_')
            ).toBe(true)
        })
    })
})
