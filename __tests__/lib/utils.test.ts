...
describe('lib/utils', () => {
  describe('cn (className utility)', () => {
    ...
    it('should filter out falsy values', () => {
      const result = cn('valid-class', false, null, undefined, '', 'another-valid')
  ...
  describe('absoluteUrl', () => {
    ...
    it('should handle complex paths', () => {
      ...
      expect(result).toBe('https://example.com/api/v1/users/123?include=profile')
    })
  ...
  describe('Integration tests', () => {
    it('should work together in common scenarios', () => {
      ...
      const combinedClasses = cn(baseClasses, conditionalClasses, 'text-white')
