...
export function FooterContent({ version, currentYear }: FooterContentProps) {
    ...
    return (
        <footer className="mt-8 py-6">
            ...
            <div className="text-muted-foreground border-border container mx-auto pt-6 mt-8 flex max-w-5xl flex-col items-center justify-between gap-4 border-t px-4 text-sm md:flex-row">
