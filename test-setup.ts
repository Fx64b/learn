...
process.env.STRIPE_PUBLISHABLE_KEY = 'pk_test_fake_stripe_publishable_key_123456789'
process.env.STRIPE_WEBHOOK_SECRET = 'whsec_fake_webhook_secret_123456789'
process.env.NEXT_PUBLIC_STRIPE_PRO_MONTHLY_PRICE_ID = 'price_fake_monthly_123456789'
process.env.NEXT_PUBLIC_STRIPE_PRO_YEARLY_PRICE_ID = 'price_fake_yearly_123456789'
